import { TipoRecurso, CategoriaSlug } from "@/interfaces";

const base = "h-full w-full";

export function IconoTipoRecurso({ tipo }: { tipo: TipoRecurso }) {
  switch (tipo) {
    case "video":
      return (
...
export function IconoCategoria({ slug }: { slug: CategoriaSlug }) {
  switch (slug) {
    case "reportes":
      return (
...
export function IconoLinkExterno() {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2.5} strokeLinecap="round" strokeLinejoin="round" className="h-4 w-4">
