  ...
  return (
    <div className="p-4 rounded-[16px] shadow flex flex-col justify-between min-h-[380px] text-white bg-[linear-gradient(180deg,_#9B5FFF_0%,_#502B7D_99.99%)]  transition  duration-300  ease-in-out  hover:shadow-xl  hover:scale-105">
      ...
      <div className="flex flex-col gap-2 min-h-[80px] justify-end">
        ...
        <Link href={data.link}>
<button className="w-full h-[40px] px-4 rounded-[8px] border border-[#667085] bg-[#F5F5F5] font-semibold text-black text-sm text-center cursor-pointer transition-all duration-300 hover:text-white hover:bg-gradient-to-b hover:from-[#9B5FFF] hover:to-[#502B7D]">            Ver gratis
          </button>
        </Link>
      </div>
    </div>
