...
const Presentation = () => {
  // Función para el TTS de Presentation
  const handlePresentationTTS = () => {
    const text = "RRHH flexible para tu empresa. La primera plataforma de servicios RRHH flexible en Latam. Accedé a soluciones de talento y gestión de personal cuando y como las necesites, sin contratos rígidos.";
    speakText(text);
  };
        ...
        <div className="order-2 md:order-1 w-full md:w-1/2 lg:max-w-[600px] pt-0 md:pt-18">
          <div className="flex items-start gap-3 mb-2">
            ...
            <button
              ...
              aria-label="Escuchar presentación"
