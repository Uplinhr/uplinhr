        ...
        <div className='flex flex-wrap gap-6 justify-center font-poppins mx-8'>
            <div className="border border-[#502B7D] rounded-[25px]">
                <div className="bg-[#6C4099] text-white min-h-30 py-9 px-8 rounded-t-[25px]">
                    ...
                    <p className="text-[16px] text-white text-opacity-50">
                        Ideal para implementar procesos y acompañar momentos 
                        clave.
                    </p>
                </div>
                <div className="pl-6 pt-2 rounded-b-[25px]">
                    <p className="max-w-110 text-[18px] mb-2">
                        Sumá una persona experta en gestión de talento a tu 
                        equipo, sin contratar en relación de dependencia.
                    </p>
            ...
            <div className="border border-[#502B7D]  rounded-[25px]">
                <div className="bg-[#CDBADA] min-h-30 pt-5 pb-4 px-8  rounded-t-[25px]">
                    <h3 className="text-[24px] font-semibold max-w-100">
                        ¿Necesitás contratar más perfiles de los que incluye 
                        tu plan mensual? 
                    </h3>
                    <p>
                ...
                <div className="pl-6">
                    <p className="text-[18px] mt-2 mb-8">
                    ...
                    <p className="text-[18px]">
                        Podés usarlos cuando quieras, según tus necesidades.
                    </p>
                </div>
            </div>
        </div>
