...
const UserDashboard = () => {
  ...
  const { cambiarClave, postConsulta, postBusqueda } = useUserStore();
    ...
    <div className="p-6 bg-white font-poppins min-h-screen flex flex-col items-center">
      ...
      {isModalPasswordOpen && (
        <div className="fixed inset-0 z-50 flex justify-center items-center">
          <div className="absolute inset-0 bg-black opacity-70" onClick={() => setIsModalPasswordOpen(false)}></div>
      ...
      {isModalConsultaOpen && (
        <div className="fixed inset-0 z-50 flex justify-center items-center">
          <div className="absolute inset-0 bg-black opacity-70" onClick={() => setIsModalConsultaOpen(false)}></div>
          <div className="relative bg-white rounded-2xl p-6 w-full max-w-md shadow-xl z-10 mx-4">
            <button
      ...
      {isModalBusquedaOpen && (
        <div className="fixed inset-0 z-50 flex justify-center items-center">
          <div className="absolute inset-0 bg-black opacity-70" onClick={() => setIsModalBusquedaOpen(false)}></div>
          <div className="relative bg-white rounded-2xl p-6 w-full max-w-md shadow-xl z-10 mx-4">
            <button
